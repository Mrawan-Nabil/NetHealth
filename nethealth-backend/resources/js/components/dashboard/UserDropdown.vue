<script setup>
import { router } from '@inertiajs/vue3'; // Changed to Inertia router!
...
<template>
    <div class="relative" ref="dropdownRef">
        <button
            ...
            class="flex items-center gap-3 rounded-lg px-3 py-2 transition-all duration-200 hover:shadow-sm"
        >
            <img
                :src="user?.avatar || '/images/default-avatar.png'"
                :alt="user?.full_name || 'User'"
                class="h-9 w-9 rounded-full object-cover ring-2 ring-gray-100 transition-all duration-200"
        ...
        <Transition name="dropdown">
            <div
                ...
                class="absolute right-0 z-50 mt-2 w-64 overflow-hidden rounded-xl border shadow-lg"
            >
                <div :class="isDark ? 'border-[#334155] bg-[#111827]' : 'border-[#E5E7EB] bg-[#F8FAFC]'" class="border-b px-6 py-4">
                ...
                <div class="py-2">
                    <button
                        ...
                        class="flex w-full items-center gap-3 px-6 py-3 text-left transition-all duration-200"
                    >
                        <svg
                ...
                <div :class="isDark ? 'border-[#334155]' : 'border-[#E5E7EB]'" class="border-t py-2">
                    <button
                        @click="handleLogout"
                        class="flex w-full items-center gap-3 px-6 py-3 text-left transition-all duration-200 hover:bg-[#EF4444]/10"
                    >
