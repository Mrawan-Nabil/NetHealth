...
const props = withDefaults(defineProps<{ variant?: Variant; size?: Size; disabled?: boolean; block?: boolean }>(), {
    variant: 'secondary',
    size: 'md',
    disabled: false,
    block: false,
...
<template>
    <button type="button" :class="classes" :disabled="disabled"><slot /></button>
</template>
