...
type Variant = 'primary' | 'secondary' | 'ghost' | 'success' | 'icon' | 'danger-soft';
type Size = 'sm' | 'md';
...
const classes = computed(() => {
    const variants: Record<Variant, string> = {
        ...
        icon: 'border border-red-200 bg-white text-red-500 hover:bg-red-50 dark:border-red-500/30 dark:bg-[#1E293B] dark:text-red-300 dark:hover:bg-red-500/10',
        'danger-soft': 'border border-red-200 bg-red-50 text-red-600 hover:bg-red-100 dark:border-red-500/30 dark:bg-red-500/10 dark:text-red-300',
    };
