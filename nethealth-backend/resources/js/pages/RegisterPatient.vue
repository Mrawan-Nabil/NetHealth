                                ...
                                <form v-else-if="stepIndex === 2" class="grid grid-cols-2 gap-4" @submit.prevent>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-xl border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-primary/30 focus:outline-none"
                                            :class="{ 'border-red-500 focus:ring-red-500/30': allergiesError }"
                                        ></textarea>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-xl border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-primary/30 focus:outline-none"
                                            :class="{ 'border-red-500 focus:ring-red-500/30': chronicConditionsError }"
                                        ></textarea>
                                        <span v-if="chronicConditionsError" class="mt-1 block text-sm text-red-500">{{
                                            chronicConditionsError
                                        }}</span>
                                    </div>
