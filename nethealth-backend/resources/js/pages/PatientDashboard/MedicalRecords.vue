    ...
    <div :class="isDark ? 'bg-[#0F172A]' : 'bg-[#F8FAFC]'" class="min-h-screen transition-colors duration-300">
        ...
        <div class="ml-64">
            ...
            <main class="p-6">
                ...
                <!-- Page Header -->
                <div class="mb-6">
                    <h1 :class="isDark ? 'text-[#F8FAFC]' : 'text-[#111827]'" class="mb-1 text-2xl font-bold">Prescriptions</h1>
                    <p :class="isDark ? 'text-[#94A3B8]' : 'text-[#6B7280]'" class="text-sm">
                        View and manage prescriptions that issued from your appointments.</p>
                </div>
                <!-- Prescriptions Grid -->
