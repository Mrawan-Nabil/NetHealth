...
const openRescheduleModal = (apt) => {
    selectedAppointment.value = apt || props.nextAppointment;
...
const handleRescheduleConfirm = (payload) => {
    ...
    router.put(
        ...
        },
        {
            preserveScroll: true,
            onSuccess: () => {
                // The modal close() function is already handled inside RescheduleModal.vue
                // But you can clear the selected appointment here
...
const markNotificationAsRead = (id) => {
    const n = props.notifications.find((n) => n.id === id);
    if (n) n.read = true;
};
...
<template>
    <div :class="isDark ? 'bg-[#0F172A]' : 'bg-[#F8FAFC]'" class="min-h-screen transition-colors duration-300">
        ...
        <div class="ml-64">
            ...
            <main class="animate-fadeInUp space-y-6 p-7">
                <!-- ── Welcome banner ── -->
                <div
                ...
                >
                    <div>
                        ...
                        <p :class="isDark ? 'text-[#64748B]' : 'text-[#94A3B8]'" class="text-sm">Here's your health overview for today.</p>
                    </div>
                    <!-- Today's date pill -->
                    <div
                ...
                <div
                    class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#0D9488] via-[#14B8A6] to-[#0891B2] p-6 text-white shadow-lg shadow-teal-500/15"
                >
                    <!-- Background decoration -->
                    <div class="pointer-events-none absolute -top-8 -right-8 h-40 w-40 rounded-full bg-white/5" />
                    <div class="pointer-events-none absolute right-20 bottom-0 h-24 w-24 rounded-full bg-white/5" />

                    <div class="relative z-10 flex items-center justify-between gap-6">
                        <div class="flex-1">
                            <p class="mb-1 text-xs font-semibold tracking-wider text-white/70 uppercase">Quick Action</p>
                        ...
                        <div class="flex shrink-0 flex-col items-end gap-2">
                            <button
                                ...
                                class="flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-bold text-[#0D9488] shadow-lg shadow-black/10 transition-all duration-200 hover:-translate-y-0.5 hover:bg-gray-50 hover:shadow-xl active:translate-y-0"
                            >
                            ...
                            <p class="text-[10px] tracking-widest text-white/60 uppercase">Takes less than 2 minutes</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div
                        ...
                        class="animate-fadeInUp stagger-4 group cursor-pointer rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 p-5 shadow-lg shadow-violet-500/20 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-violet-500/30"
                    >
                        ...
                        <p class="mb-3 text-xs leading-relaxed text-white/75">Ask our AI Medical Assistant for quick answers.</p>
                    ...
                    <div class="space-y-6 lg:col-span-2">
                        ...
                        >
                            <div class="mb-5 flex items-center justify-between">
                                <h3 :class="isDark ? 'text-[#F1F5F9]' : 'text-[#0F172A]'" class="text-sm font-semibold">Recent Medical Records</h3>
                                <Link
                            ...
                            <div v-else class="py-8 text-center">
                                <p :class="isDark ? 'text-[#475569]' : 'text-[#94A3B8]'" class="text-sm">No recent records to display.</p>
                            </div>
                        </div>
                    </div>
