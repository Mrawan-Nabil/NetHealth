                ...
                <div v-else>
                    ...
                    <div class="mb-6">
                        <p :class="isDark ? 'text-[#94A3B8]' : 'text-[#9CA3AF]'" class="text-sm">
                            ...
                            <Link href="/test-results" class="transition-colors hover:text-[#14B8A6]">Test Result</Link>
                            <span class="mx-2">/</span>
                    ...
                    <div class="mb-6 flex items-start justify-between">
                        <div>
                            <h1 :class="isDark ? 'text-[#F8FAFC]' : 'text-[#111827]'" class="mb-1 text-2xl font-bold">Test Report Details</h1>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button
                                ...
                                :class="isDark ? 'bg-[#14B8A6] shadow-lg shadow-teal-500/20 hover:bg-[#2DD4BF]' : 'bg-[#14B8A6] hover:bg-[#0D9488]'"
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <DoctorInterpretationCard :interpretation="testResult.interpretation" :doctor="testResult.doctor" :is-dark="isDark" />
                        <AttachmentsCard :attachments="testResult.attachments" :is-dark="isDark" @download="handleDownloadAttachment" />
                    </div>
                </div>
            </main>
        </div>
