...
<template>
  <!-- Fade In للصفحة بأكملها عند التحميل مع حركة خفيفة من الأسفل -->
  <Transition name="page-fade" appear>
    <div class="space-y-6">
              ...
              <form v-if="stepIndex === 0" class="grid grid-cols-2 gap-4" @submit.prevent>
                ...
                >
                  <template #icon>
                    <button
                      type="button"
                      class="rounded p-1 text-gray-500 transition-colors duration-200 hover:text-gray-700"
              ...
              <form v-else-if="stepIndex === 2" class="grid grid-cols-2 gap-4" @submit.prevent>
                ...
                <div class="col-span-2">
                  ...
                  <textarea
                    ...
                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-gray-900 placeholder-gray-500 transition-all duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
                ...
                <div class="col-span-2">
                  ...
                  <button
                    type="button"
                    class="flex w-full flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50/50 py-8 text-gray-600 transition-all duration-200 hover:scale-[1.01] hover:border-primary hover:bg-primary/5 hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
      ...
      <p class="text-center text-sm text-gray-600">
        ...
        <RouterLink to="/login" class="font-medium text-primary transition-colors duration-200 hover:text-primary/80 hover:underline">Login</RouterLink>
      </p>
    </div>
  </Transition>
</template>
